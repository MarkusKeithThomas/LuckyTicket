...
public class HomeFragmentAdapter extends RecyclerView.Adapter<HomeFragmentAdapter.MyCardViewProvince> {
    private List<MainScreenSalerProvince> mainScreenSalerProvinceList;
    private MyClickEvent myClickEvent;

    public HomeFragmentAdapter(List<MainScreenSalerProvince> mainScreenSalerProvinceList, MyClickEvent myClickEvent) {
